...
instance.defaults.headers = {
  ...
  // "Api-version": "1.0",
  "X-Access-Token":
    "1a661eec9bf358b8567c3dc022146d19c69d2ceafe92f503e89391e5d9f9f739",
};
...
export default {
  // templates
  templates(method, data) {
    switch (method) {
      case "get":
        return instance.get("/api/v1/templates");

      case "get-one":
        return instance.get(`/api/v1/templates/${data}`);

      case "post":
        return instance.post("/api/v1/templates", data);

      case "put":
        return instance.put("/api/v1/templates", data);

      case "delete":
        return instance.delete("/api/v1/templates", { data });

      default:
        throw new Error("Unknown templates API method");
    }
  },
